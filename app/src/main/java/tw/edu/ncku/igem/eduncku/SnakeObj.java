...
public class SnakeObj {
    ...
    public SnakeObj(Activity content, Rect actRect) {
        ...
        // 頭部影像資源
        Drawable d_head = rs.getDrawable(R.drawable.head, null);
        // 身體影像資源
        Drawable d_body = rs.getDrawable(R.drawable.body, null);
        // 尾部影像資源
        Drawable d_tail = rs.getDrawable(R.drawable.tail, null);
