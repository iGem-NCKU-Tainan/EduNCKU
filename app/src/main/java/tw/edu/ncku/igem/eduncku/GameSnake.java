...
public class GameSnake extends Activity {
        ...
        surfaceHolder.addCallback(new SurfaceHolder.Callback() {
            ...
            public void surfaceCreated(SurfaceHolder arg0) {
                if (backimg == null) {
                    ...
                    backimg.setRect(new Rect(sv.getLeft(), sv.getTop(), sv.getRight(), sv.getBottom()));
                    readyGame();
                } else {
                    // 經由Activity返回載入時
                    draw(nowDrawWork);
    ...
    private void set_element(){
        ...
        if (snake.isEatApple(promoter) && achievement_elements_table[current_achievement_i][current_achievement_j] == 1) {
            ...
            MainActivity.Achievement_array.set(current_achievement_i, Boolean.TRUE); // Unlock the achievement in Achievement.java
